...
export default function AdminSettingsPage() {
  const [settings, setSettings] = useState<Settings>({
    ...
    coreValues: "",
    officeAddress:
      "No. 1168, Min Ye' Kyaw Swar Road, 6th Quarter, East Dagon Township, Yangon, Myanmar",
  });
  ...
  const handleChartUpload = async () => {
    ...
    try {
      ...
      if (saveRes.ok) {
        ...
        setMessage({
          type: "success",
          text: "Organization chart uploaded successfully!",
        });
      } else {
      ...
      setMessage({
        ...
        text:
          error instanceof Error
            ? error.message
            : "Failed to upload organization chart",
      });
    } finally {
  ...
  const handleSaveIndividual = async (key: keyof Settings) => {
    ...
    try {
      ...
      if (res.ok) {
        setMessage({
          type: "success",
          text: `${key.charAt(0).toUpperCase() + key.slice(1)} updated successfully!`,
        });
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <textarea
              ...
              onChange={(e) =>
                setSettings({ ...settings, attitude: e.target.value })
              }
              className="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              rows={3}
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <textarea
              ...
              onChange={(e) =>
                setSettings({ ...settings, coreValues: e.target.value })
              }
              className="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              rows={4}
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <textarea
              ...
              onChange={(e) =>
                setSettings({ ...settings, history: e.target.value })
              }
              className="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              rows={6}
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Default: No. 1168, Min Ye&apos; Kyaw Swar Road, 6th Quarter, East
