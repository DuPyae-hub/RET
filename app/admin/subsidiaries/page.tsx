  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormMessage({
          type: "error",
          text: error.error || "Failed to save subsidiary",
        });
      }
    } catch (error) {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      if (res.ok) {
        setFormMessage({
          type: "success",
          text: "Subsidiary deleted successfully!",
        });
        fetchSubsidiaries();
      } else {
        const error = await res.json();
        setFormMessage({
          type: "error",
          text: error.error || "Failed to delete subsidiary",
        });
      }
    } catch (error) {
                ...
                {editingSubsidiary &&
                  ...
                  !previewUrl && (
                    <div className="mt-4">
                      ...
                      <div className="relative w-32 h-32 border border-gray-200 rounded-lg overflow-hidden">
                        <Image
                          src={editingSubsidiary.imageUrl}
                          alt="Current"
                          fill
                          className="object-cover"
                        />
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {Array.isArray(subsidiaries) && subsidiaries.length > 0 ? (
                ...
                <tr>
                  ...
                  >
                    No subsidiaries found. Click &quot;Add New Subsidiary&quot;
                    to create one.
                  </td>
                </tr>
              )}
