...
export default async function AgriculturalFriendsPage() {
  ...
  return (
    <SubsidiaryLayout
      ...
      breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Agricultural Friends', href: '/agricultural-friends' }]}
      ...
      services={[
        { icon: <Leaf className="w-7 h-7" />, title: 'Agricultural Inputs', description: 'Seeds, fertilizers, and farming supplies.' },
        { icon: <Settings className="w-7 h-7" />, title: 'Equipment', description: 'Farming machinery and tools.' },
        { icon: <BookOpen className="w-7 h-7" />, title: 'Training Programs', description: 'Educational workshops and support.' },
        { icon: <ShoppingCart className="w-7 h-7" />, title: 'Market Access', description: 'Connecting farmers to markets.' },
      ]}
      extraSections={
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="card-ret p-6 md:p-8 border-l-4 border-[#059669]">
              <h3 className="text-xl font-semibold text-[#0F2942] mb-4">Our Commitment</h3>
